...
namespace Infrastructure.Implementation.QuartsService.Jobs.CreateCandidate
{
    ...
    public class CreateCandidateJob : ICreateCandidateJob
    {
        private readonly ILogger<ICreateCandidateJob> _logger;
        ...
        public CreateCandidateJob(ILogger<ICreateCandidateJob> logger, NeocaseRootProvider neocase, IEmployeeRepository employeeRepository, IHrDirectoryRepository hrDirectoryRepository, IRegionCenterRepository regionCenterRepository)
        {
            _logger = logger;
            _neocase = neocase;
        ...
        {
            _logger.LogInformation("Start create candidate job");
            ...
            _ = await _neocase.NeocaseCaseProvider.ExecuteRule(newCaseId, 1592);
